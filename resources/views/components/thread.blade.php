<article class="p-5 bg-white shadow">
    ...
    <div class="relative grid grid-cols-8 gap-2">
        ...
        <div class="col-span-6 space-y-4">
            ...
            <div class="flex space-x-6">
                ...
                {{-- Comments Count --}}
                <div class="flex items-center space-x-2">
                    <x-heroicon-o-chat-alt class="w-5 h-5 text-green-500" />
                    <span class="text-xs font-bold">{{ count($thread->replies()) }}</span>
                </div>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xs font-bold">{{ $thread->created_at->diffForHumans() }}</span>
                </div>
            </div>
        </div>
